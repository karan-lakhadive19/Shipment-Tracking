...
const CompleteShipment = ({ contract }) => {
    ...
    return (
        ...
        <h5 className="text-xl font-medium text-gray-900 dark:text-white py-6">Complete Shipment</h5>
        <form style={{ marginBottom: '20px' }}>
            ...
            <button type="submit" onClick={completeShipment} className="w-1/2 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Complete Shipment</button>
        </form>
    </div>
